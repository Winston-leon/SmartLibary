...
<div region="north" style="height: 78px;background-color: #ffff">
    <table width="100%">
        ...
        <tr>
            <td width=50%></td>
            <td valign="bottom" style="font-size: 20px;color:#8B8B8B;font-family: '楷体';"
                align="right" width="50%">
                <a href="javascript:openPasswordModifyDialog()" class="easyui-linkbutton"
                    plain="true">
                    <font size="3"> <strong>修改密码</strong> </font>
                </a>
            </td>
        </tr>
    </table>
...
<div region="west" style="width: 200px;height:500px;" title="导航菜单"
    ...
    <div class="easyui-accordion">
        ...
        <div title="图书借还" data-options="iconCls:'icon-shuji'"
             style="padding:10px">
            <a href="javascript:openTab(' 图书借还', 'bookBorrow.jsp', 'icon-shuben')"
               class="easyui-linkbutton"
        ...
        <div title="系统管理" data-options="iconCls:'icon-item'"
            ...
            <a href="javascript:openTab(' 用户管理','userManage.jsp','icon-lxr')"
               ...
               data-options="plain:true,iconCls:'icon-lxr'" style="width: 150px;">
                用户管理</a><a href="javascript:logout()"
                                                                class="easyui-linkbutton"
